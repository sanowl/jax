...
from jax._src.core import (
  ...
  unsafe_ensure_compile_time_eval_for_equinox as unsafe_ensure_compile_time_eval_for_equinox,
  unsafe_get_axis_names as unsafe_get_axis_names_DO_NOT_USE,
  unsafe_get_current_trace as unsafe_get_current_trace_DO_NOT_USE,
  ...
  concrete_eval as concrete_eval,
