...
# TODO(dougalm): consider imitating the old behavior more faithfully by having a
# "fold eagerly" context bit that DynamicJaxprTrace looks at to decide whether
# to stage out an op with constant args.
@contextmanager
def unsafe_ensure_compile_time_eval_for_equinox():
  yield
